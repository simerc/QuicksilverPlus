...
using EPiServer.Reference.Commerce.Site.Features.Global.AddressBook.ViewModels;
...
namespace EPiServer.Reference.Commerce.Site.Features.Global.AddressBook.Controllers
{
    [Authorize]
